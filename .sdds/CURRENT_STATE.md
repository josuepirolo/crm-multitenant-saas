...
| Contacts | IMPLEMENTADO | CRUD, filtros, paginação, multi-tenant, soft delete; importação em massa via planilha (XLSX/CSV) implementada 2026-06-08 — typecheck+testes OK, **ainda não commitado nem testado em navegador** |
