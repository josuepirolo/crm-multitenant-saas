          ...
          <div className="rounded-2xl border border-border/50 bg-card p-6 space-y-5">
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  { label: "Google Auth",     icon: "G", color: "text-[#4285F4] bg-[#4285F4]/10" },
                  { label: "Microsoft Auth",  icon: "M", color: "text-[#00A4EF] bg-[#00A4EF]/10" },
                  { label: "Authy / outros",  icon: "A", color: "text-[#EC1B24] bg-[#EC1B24]/10" },
                ].map(({ label, icon, color }) => (
                  <div key={label} className="flex flex-col items-center gap-1.5 rounded-xl border border-border/50 bg-muted/30 p-3">
                    <div className={cn("h-9 w-9 rounded-xl flex items-center justify-center text-base font-bold", color)}>
                      {icon}
                    </div>
